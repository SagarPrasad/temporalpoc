...
public class SearchableWorkFlow {
  ...
  public static void exec() {
     ...
     */
    worker.registerWorkflowImplementationTypes(SearchableWorkFlow.GreetingWorkflowImpl.class);

    /**
     * Register our Activity Types with the Worker. Since Activities are stateless and thread-safe,
     * the Activity Type is a shared instance.
     */
    worker.registerActivitiesImplementations(new SearchableWorkFlow.GreetingActivitiesImpl());
    ...
    SearchableWorkFlow.GreetingWorkflow workflow =
        client.newWorkflowStub(SearchableWorkFlow.GreetingWorkflow.class, workflowOptions);
